...
class ItemRepositoryTest {
    ...
    public void findByPriceLessThenOrderByPriceDesc(){
        this.createItemList();
    ...
    @Test
    @DisplayName("nativeQuery 를 이용한 상품조회 테스트")
    ...
    public void queryDslTest(){
        ...
        List<Item> itemList1 = queryFactory.selectFrom(qItem)
...
//        List<Item> itemList = query.fetch();
    ...
    public void queryDslTest2(){
        ...
        Page<Item> itemPagaingResult = itemRepository.findAll(booleanBuilder,pageable);
        System.out.println("total elements : " + itemPagaingResult.getTotalElements());

        List<Item> resultItemList = itemPagaingResult.getContent();
